...
do
	...
	OUTFILE=pi0Output/TauScan_NR/Normal/TauScan_PbPb_NR_Tau_$TAUI''_Cent_30_50_S_5023_Set4_Pt_FarAve/TauScan_PbPb_NR_Tau_$TAUI''_Cent_30_50_S_5023_Set4_Pt_Normal_FarAve.pi0final.root
	ARGSTRING="$ARGSTRING $OUTFILE \"#tau_{i} = $TAUIVALUE\""
	FILELIST="$FILELIST $OUTFILE"

done

CompareDir=pi0Output/TauScan_NR/Normal/Cent_30_50/Cmp_FarAve
mkdir -p $CompareDir
