...
do
	...
	OUTFILE=pi0Output/TauScan_NR/NoToy/TauScan_PbPb_NR_Tau_$TAUI''_Cent_50_80_S_5023_Set3_Pt_NoToy_FarAve/TauScan_PbPb_NR_Tau_$TAUI''_Cent_50_80_S_5023_Set3_Pt_NoToy_FarAve.pi0final.root
	ARGSTRING="$ARGSTRING $OUTFILE \"#tau_{i} = $TAUIVALUE\""
	FILELIST="$FILELIST $OUTFILE"

done

CompareDir=pi0Output/TauScan_NR/NoToy/Cent_50_80/Cmp_FarAve
mkdir -p $CompareDir
