...
do
	...
	OUTFILE=pi0Output/TauScan_NR/NoFlow/TauScan_PbPb_NR_Tau_$TAUI''_Cent_30_50_S_5023_Set2_Pt_NoFlow_ZYAM/TauScan_PbPb_NR_Tau_$TAUI''_Cent_30_50_S_5023_Set2_Pt_NoFlow_ZYAM.pi0final.root
	ARGSTRING="$ARGSTRING $OUTFILE \"#tau_{i} = $TAUIVALUE\""
	FILELIST="$FILELIST $OUTFILE"

	#OUTFILE=pi0Output/TauScan_NR/NoFlow/TauScan_PbPb_NR_Tau_$TAUI''_Cent_30_50_S_5023_Set2_Pt_NoFlow_ZYAM.pi0final.root
